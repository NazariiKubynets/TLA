...
?>
    ...
    <section class="safe-travels-top-places top-places">
        <div class="top-places__container container">
    ...
    <section class="safe-travels">
        <div class="safe-travels__container container the-content">
            <?php the_content(); ?>
        </div>
    </section>
