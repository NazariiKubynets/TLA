...
//////////// SINGLE BLOG POST/////////////
        if (document.querySelector('.author-hero')) {

            const elements = document.querySelectorAll('.author-hero__row');
            const tl = gsap.timeline();
...
///////////LIST DESTINATIONS////////////
        if (document.querySelector('.top-places')) {
            ...
            showItem(items);
            if (document.querySelector('.top-places__btn')) {
                seeMoreBtn.addEventListener('click', () => {
                    itemsHiddenDesk.forEach(item => {
                        item.classList.remove('hidden');
                    });
                    showItem(itemsHiddenDesk);
                });
            }
        }
